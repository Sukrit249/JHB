...
var durTime = document.querySelector('#durTime'); //const tl = gsap.timeline({ defaults: { ease: "power1.out" } });
// Song titles

var songs = ['Full-Speed', 'Hydra-Stage', 'Voices']; // Keep track of song
...
function loadSong(songs) {
  ...
  audio.src = "music/".concat(songs, ".mp3");
  cover.src = "img/".concat(songs, ".jpg");
} // Play song
...
audio.addEventListener('timeupdate', durTime); //landing animation gsap
